...
OPAL_MODULE_DECLSPEC extern accelerator_cuda_func_table_t opal_accelerator_cuda_func;
OPAL_MODULE_DECLSPEC extern CUstream opal_accelerator_cuda_memcpy_stream;
OPAL_MODULE_DECLSPEC extern opal_mutex_t opal_accelerator_cuda_stream_lock;
